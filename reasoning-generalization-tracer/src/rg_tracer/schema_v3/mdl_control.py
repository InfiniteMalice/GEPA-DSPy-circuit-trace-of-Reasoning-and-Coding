...
def build_mdl_control_overlay(
    *,
    ...
    conflict = bool(
        ...
        and controlled_answer is not None
        and default_answer != controlled_answer
    )
    ...
    return MDLControlOverlay(
        ...
        escalation_taken=bool(escalation_required and controlled_answer is not None),
        compression_candidate=bool(
            not escalation_required
            and default_answer is not None
            and controlled_answer is not None
            and default_answer == controlled_answer
        ),
