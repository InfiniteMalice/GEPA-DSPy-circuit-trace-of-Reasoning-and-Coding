...
Follow the pre-commit checklist in `AGENTS.md`. For documentation-only changes, verify that
`AGENTS.md`, `.beads/instructions.md`, and related standards stay synchronized.
